...
namespace SimpleQ.PageModels.QuestionPageModels
{
    ...
    /// </summary>
    public class PolytomousOSQuestionPageModel : BasicQuestionPageModel
    {
        ...
        public PolytomousOSQuestionPageModel(IQuestionService questionService) : base(questionService)
        {
        ...
        /// Without Parameter
        /// </summary>
        public PolytomousOSQuestionPageModel()
        {
